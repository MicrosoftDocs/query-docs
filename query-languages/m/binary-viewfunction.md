...
The `OnInvoke` handler of [`Binary.View`](binary-view.md) can be used to define a handler for the view function.
...
Refer to the published Power Query custom connector documentation for a more complete description of [`Binary.View`](binary-view.md) and custom view functions.
