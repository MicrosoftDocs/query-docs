...
|[`Replacer.ReplaceValue`](replacer-replacevalue.md)|This function be provided to [`List.ReplaceValue`](list-replacevalue.md) or [`Table.ReplaceValue`](table-replacevalue.md) to do replace values in list and table values respectively.|
