...
* `encoding`: (Optional) The encoding used to convert the binary to text. Use [`TextEncoding.Type`](textencoding-type.md) to specify the type of encoding. If this value isn't specified, the function attempts to auto-detect the encoding or falls back to [`TextEncoding.Utf8`](textencoding-type.md).
