...
|[ISBOOLEAN](isboolean-function-dax.md) | Checks whether a value is a logical value, (`TRUE` or `FALSE`), and returns `TRUE` or `FALSE`. Alias of [ISLOGICAL](islogical-function-daxmd).|
