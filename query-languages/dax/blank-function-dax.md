...
## Remarks  
Blanks are not equivalent to nulls. DAX uses blanks for both database nulls and for blank cells in Excel. For more information, see [Data types supported in tabular modelsr)](/analysis-services/tabular-models/data-types-supported-ssas-tabular.md).  
