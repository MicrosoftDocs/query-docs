...
Unlike [INFO.RELATIONSHIPS](info-relationships-function-dax.md), this function can be used in calculated tables, columns, and measures of a semantic model, including as part of a model refresh.
