...
- The CURRENCY function rounds up the 5th significant decimal, in value, to return the 4th decimal digit; rounding up occurs if the 5th significant decimal is equal or larger than 5. For example, if value is 3.6666666666666 then converting to currency returns &dollar;3.6667; however, if value is 3.0123456789 then converting to currency returns &dollar;3.0123.  
  
- If the data type of the expression is TrueFalse then CURRENCY( &lt;TrueFalse&gt;) will return &dollar;1.0000 for True values and &dollar;0.0000 for False values.  
...
Returns the value &dollar;1234.5600.
