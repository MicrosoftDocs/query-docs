...
|("ABC")|Display the string inside the double quotation marks (" "). To include a string in **_format_** from within code, you must use **Chr(34)** to enclose the text (34 is the character code for a quotation mark (")).|
