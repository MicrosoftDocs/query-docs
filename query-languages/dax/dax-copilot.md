...
:::image type="content" source="media/dax-copilot/dax-copilot-conversational-query.png" alt-text="Screenshot showing Run DAX query generated by Fabric Copilot." lightbox="media/dax-copilot/dax-copilot-conversational-query.png":::

When I select **keep query**, the query is added to the query tab. 

### Add a column and show the diff view
...
### Explain DAX topics with context
