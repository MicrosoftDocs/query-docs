...
> [!NOTE]  
> This function is included in SQL Server 2016 Analysis Services (SSAS), Power Pivot in Excel 2016, and Power BI Desktop. Information provided here is subject to change.  
  
Returns the geometric mean of an expression evaluated for each row in a table.  
  
To return the geometric mean of the numbers in a column, use [GEOMEAN Function &#40;DAX&#41;](../DAX/geomean-function-dax.md).  
...
## See Also  
[GEOMEAN Function &#40;DAX&#41;](../DAX/geomean-function-dax.md)  
