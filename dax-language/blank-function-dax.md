...
f1_keywords: 
  - "sql13.as.daxref.BLANK.f1"
helpviewer_keywords: 
  - "BLANK function"
  - "blanks"
ms.assetid: b9c0c031-20d0-41ac-b5d3-840280affd93
...
Some DAX functions treat blank cells somewhat differently from Microsoft Excel. Blanks and empty strings ("") are not always equivalent, but some operations may treat them as such. For details on the behavior of an individual function or operator, see [DAX Function Reference](../DAX/dax-function-reference.md).  
